...
import 'package:chatterly/constants/constants.dart';
import 'package:chatterly/models/models.dart';
import 'package:chatterly/providers/providers.dart';
  ...
  Widget buildSticker() {
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
            border: Border(top: BorderSide(color: ColorConstants.white, width: 0.5)), color: Colors.white),
